...
## Master Implementation Prompt · v2_2

Canonical filename: `Universal_Master_Prompt_v2_2.md`
Revision date: 2026-09-19.

This revision standardizes the document title, canonical filename, and version metadata. The complete eight-step implementation requirements, including ledger durability, exact-checkpoint publication, interrupted-run continuation, and recall freshness, remain unchanged.
...
Inspect repository instructions and any existing SynthBit files before execution. Determine:
